...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dallal.Areas.Area", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dallal.DetailDefinition.DetailsDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dallal.DetailDefinition.DetailsDefinitionOption", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dallal.Listings.Listing", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dallal.Listings.ListingDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dallal.Otps.Otp", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Volo.Abp.PermissionManagement.PermissionDefinitionRecord", b =>
                {
                    ...
                    b.Property<string>("MultiTenancySide")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Dallal.Identity.BrokerIdentity", b =>
                {
                    b.HasBaseType("Volo.Abp.Identity.IdentityUser");

                    b.HasDiscriminator().HasValue("BrokerIdentity");
                });

            modelBuilder.Entity("Dallal.Identity.CustomerIdentity", b =>
                {
                    b.HasBaseType("Volo.Abp.Identity.IdentityUser");
            ...
            modelBuilder.Entity("Dallal.Areas.Area", b =>
                {
                    b.HasOne("Dallal.Areas.Area", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Dallal.DetailDefinition.DetailsDefinitionOption", b =>
                {
                    b.HasOne("Dallal.DetailDefinition.DetailsDefinition", null)
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Dallal.Listings.Listing", b =>
                {
                    b.HasOne("Dallal.Areas.Area", "Area")
                        .WithMany()
                        .HasForeignKey("AreaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dallal.Identity.BrokerIdentity", "Broker")
                        .WithMany()
            ...
            modelBuilder.Entity("Dallal.Listings.ListingDetail", b =>
                {
                    b.HasOne("Dallal.DetailDefinition.DetailsDefinition", "Definition")
                        .WithMany()
                        .HasForeignKey("DefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dallal.Listings.Listing", null)
                        .WithMany("Details")
                        .HasForeignKey("ListingId");

                    b.HasOne("Dallal.DetailDefinition.DetailsDefinitionOption", "Option")
                        .WithMany()
